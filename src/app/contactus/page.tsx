...
const ContactUsPage = () => {
  ...
  <ul className="timeline-list list-unstyled">
    <li className="d-flex align-items-start mb-4">
      <div className="circle   d-flex justify-content-center align-items-center fw-bold me-3">1</div>
      <p className="mb-0">We'll review your cybersecurity needs.</p>
    </li>
    <li className="d-flex align-items-start mb-4">
      <div className="circle   d-flex justify-content-center align-items-center fw-bold me-3">2</div>
      <p className="mb-0">You'll receive a customized security proposal.</p>
    </li>
    <li className="d-flex align-items-start">
      <div className="circle  d-flex justify-content-center align-items-center fw-bold me-3">3</div>
      <p className="mb-0">Once approved, we'll implement the solutions and support you.</p>
    </li>
  </ul>
</div>
